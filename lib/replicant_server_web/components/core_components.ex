defmodule ReplicantServerWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: ReplicantServerWeb.Gettext
  ...
  def flash(assigns) do
    ...
    <div
      ...
      {@rest}
    >
      <p class="text-sm leading-5 font-medium"><%= msg %></p>
    </div>
    """
  end

  @doc """
  Shows the flash group with info and error messages.
  """
  ...
  @doc """
  Renders a data list for showing key/value pairs.
  """
